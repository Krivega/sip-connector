...
export const HEADER_START_PRESENTATION = 'X-WEBRTC-SHARE-STATE: LETMESTARTPRESENTATION';
export const HEADER_STOP_PRESENTATION = 'X-WEBRTC-SHARE-STATE: STOPPRESENTATION';
