...
| Call          | `idle`, `connecting`, `presentationCall`, `roomPendingAuth`, `purgatory`, `p2pRoom`, `directP2pRoom`, `inRoom`, `disconnecting`                   | `CallManager.events` (`start-call`, `confirmed`, `end-call`, `enter-room`, `conference:participant-token-issued`, `ended`, `failed`)                                                                                   | `CALL.CONNECTING`, `CALL.PRESENTATION_CALL`, `CALL.ENTER_ROOM`, `CALL.TOKEN_ISSUED`, `CALL.START_DISCONNECT`, `CALL.RESET`           |
